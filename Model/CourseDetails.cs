...
namespace BaiCiZhanModel
{
    ...
    public class CourseDetails
    {
        ...
        private string cD_RIGHT_PIC;
        public string CD_RIGHT_PIC
        {
            get { return cD_RIGHT_PIC; }
            set { cD_RIGHT_PIC = value; }
        }

        private string cD_WRONG_PIC1;
        public string CD_WRONG_PIC1
        {
            get { return cD_WRONG_PIC1; }
            set { cD_WRONG_PIC1 = value; }
        }

        private string cD_WRONG_PIC2;
        public string CD_WRONG_PIC2
        {
            get { return cD_WRONG_PIC2; }
            set { cD_WRONG_PIC2 = value; }
        }

        private string cD_WRONG_PIC3;
        public string CD_WRONG_PIC3
        {
